...
document.getElementById('weightInput').addEventListener('input',  function (e) {
    document.getElementById('output').style.visibility = 'visible'
        ...
        document.getElementById('kgOutput').innerHTML = pounds*0.454;
        
        document.getElementById('tonOutput').innerHTML = pounds*0.454;

        document.getElementById('mgOutput').innerHTML = pounds*453592;
